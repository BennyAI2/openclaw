...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["users.linkAuthProfile", "users", "operator.write", "2026.8"],
  ["users.unlinkAuthProfile", "users", "operator.write", "2026.8"],
  ["users.authConnect.start", "users", "operator.write", "2026.8"],
  ["users.authConnect.complete", "users", "operator.write", "2026.8"],
  ["users.authConnect.token", "users", "operator.write", "2026.8"],
